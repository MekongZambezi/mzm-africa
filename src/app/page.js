          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/8">
            {[
              ...
              },
              {
                ...
                body: "Under Zimbabwe's May 2026 Critical Minerals framework, every foreign investment in chrome, lithium, copper, nickel, and PGMs must be structured through a Zimbabwean entity within the State SPV. MZM is that entity. This is not positioning — it is the legal requirement for any investor who wants to participate in Zimbabwe's critical minerals sector correctly.",
              },
              {
                num: '03',
      ...
      >
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-[#C4A04A] text-sm font-medium tracking-widest uppercase">Chrome · Lithium · Critical Minerals</p>
          </div>
        </div>
      </div>
